...
function ufunc1(
    ...
    return {
        r: math.mapRange(
            ...
            c.r *
                math.mapRange(
                    Random.noise2D(x, y, params.freq, 1),
                    -1,
                    1,
                    0.99,
                    1.01,
        ...
        theta:
            ...
            math.mapRange(
                sin(10 * x + c.theta) + cos(10 * y + 3 * c.theta),
                -2,
                2,
                0,
                1 / 50,
...
const sketch = (props) => {
    ...
    return ({ context, width, height, units, exporting }) => {
        ...
        const groups = [{ id: "lines1", lines: lines1 }];
